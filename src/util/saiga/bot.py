# Original file: https://github.com/IlyaGusev/rulm/blob/master/self_instruct/src/util/chat.py
...
class Conversation:
    """
    Conversation wrapper. Based on a configurations it takes a prompt and wrappes it with the syntax
    the Saiga model expects. This wrapper is mostly used by generating functions.
    """
    def __init__(
        self,
